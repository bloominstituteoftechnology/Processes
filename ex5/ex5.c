/* Write a program that forks a child and creates a shared pipe between the parent and child processes. Have the child write the three messages to the parent and have the parent print out the messages. */
